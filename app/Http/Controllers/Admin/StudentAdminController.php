    ...
    public function walletRecharge(Request $request){
        ...
        if($student) {
            ...
            if($student->mobile) {
                ...
                $msg = 'Dear student, ' . $wallet_type . $request->amount . Config::get('siteSetting.currency_symble') . ' to your woadi wallet. Current balance ' . $total_amount . Config::get('siteSetting.currency_symble') . ' get up to 70% discount shop at '.$_SERVER['SERVER_NAME'];
