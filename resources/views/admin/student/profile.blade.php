            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-xlg-3 col-md-4">
                        <div class="card">
                            <div class="card-body">
                                <center> <img src="{{asset('upload/images/users/'.$student->photo)}}" class="img-circle" width="150" />
                                                            ...
                                                            @if(count($student->get_orders)>0)
                                                                ...
                                                                <tr>
                                                                   ...
                                                                   <td>{{\Carbon\Carbon::parse($enrolled->order_date)->format(Config::get('siteSetting.date_format'))}}
                                                                    ...
                                                                    <td>
                                                                        <span class="label label-{{ ($enrolled->Enrolled_status == 'delivered') ? 'success' : 'danger' }}">{{$enrolled->payment_status}}</span>
                                                                    </td>
                                                                </tr>
                                                               @endforeach
