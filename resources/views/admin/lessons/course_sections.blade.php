...
@section('css')
    ...
    <style type="text/css">
        ...
        svg{width: 20px}
        .course_section{padding:1px 15px;
    border-radius: 5px;
    background: #fff;
    margin-bottom: 10px;
    list-style: none;}
    .action_btn{float: right; margin-top: -35px;}
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    ...
                    <div class="col-md-7 align-self-center text-right">
                        <div class="d-flex justify-content-end align-items-center">
                           ...
                           <button data-toggle="modal" data-target="#addSectionModal" class="btn btn-info d-none d-lg-block m-l-15"><i class="fa fa-plus-circle"></i> Add New Section</button>
                        </div>
                    </div>
                </div>
                <!-- ============================================================== -->
                ...
                <div class="row justify-content-md-center">
                    ...
                    <div class="col-md-10">
                        <div class="table-responsive" >
                            <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                                ...
                                <li id="section{{$section->id}}" class="course_section">
                                    <div class="panel panel-default">
                                        <div class="panel-heading @if($secIndex == 0) active @endif" role="tab" >
                                      <h4 class="panel-title">
                                        <a role="button" data-toggle="collapse" data-parent="#accordion" href="#courseSection{{ $section->id }}" aria-expanded="true" aria-controls="courseSection{{ $section->id }}"> {{$section->section_title}}
                                        </a>
                                      </h4>
                                        <span class="action_btn">
                                            <button onclick="addLesson({{$section->id}})" title="Add Lesson" class="btn btn-success btn-sm"> <i class="ti-plus"></i> Add Lesson</button>
                    ...
                    @else
                    <div class="col-md-12">
                    <h3 style="text-align: center;padding: 10px;" class="course_section">This course have no lesson. <button data-toggle="modal" data-target="#addSectionModal" class="btn btn-info btn-sm"><i class="fa fa-plus-circle"></i> Add New Section</button></h3>
                    </div>
                    @endif
                    <!-- Column -->
                </div>            
                                ...
                                <div class="row justify-content-md-center">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input  name="section_title" id="section_title" value="{{old('section_title')}}" required="" type="text" class="form-control">
                                        </div>
                                    </div>
                                ...
                                <div class="row justify-content-md-center">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input  name="lesson_title" id="lesson_title" value="{{old('lesson_title')}}" required="" type="text" class="form-control">
                                        </div>
                                    </div>
                                   ...
                                   <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="description" class="form-control" placeholder="Enter description" id="description" rows="1">{{old('description')}}</textarea>
                                        </div>
                                    </div>
...
@section('js')
   ...
   <script src="{{asset('assets')}}/node_modules/dropify/dist/js/dropify.min.js"></script>
    ...
    function lessonType(provider, field=''){
        ...
        var output = '';
        if(provider){
            output = '<span class="required">Attach '+provider+' file</span><div class="custom-file"> <input type="file" name="content"></div>';
